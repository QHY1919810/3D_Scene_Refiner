...
class DiffGaussian(Rasterizer, GaussianBatchRenderer):
    ...
    def forward(
        ...
        **kwargs
        ...
        # 优先取“纯投影矩阵”，没有就退化为 full_proj_transform
        projmatrix_raw = getattr(viewpoint_camera, "projection_matrix", projmatrix)
        ...
        raster_settings = GaussianRasterizationSettings(
            ...
            projmatrix_raw=projmatrix_raw,   # ← 新增这一项
        ...
        # 兼容不同版本的返回值（可能是 4/5/6 个）
        rendered_image, radii, rendered_depth, rendered_alpha = out[:4]
        # extras = out[4:]  # 如果你后续想用额外输出，可以先打印看看是什么
